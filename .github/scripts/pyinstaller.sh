...
if [ "$RUNNER_OS" == "Linux" ]; then
    ...
    pyinstaller --add-data 'nottodbox/color-schemes/:nottodbox/color-schemes' --add-data 'nottodbox/LICENSE.txt:nottodbox' -F -w -i share/icons/pyinstaller/io.github.mukonqi.nottodbox.icns -n nottodbox nottodbox/__main__.py
